    ...
    >
      <div className="container mx-auto px-4 h-14 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <h1 className="font-display text-lg text-foreground">Vision Goals</h1>
        </div>
        ...
        {user && (
          <div className="flex items-center gap-0.5 sm:gap-1">
            {/* Feedback Button */}
            {onFeedback && (
              <Button variant="ghost" size="sm" onClick={onFeedback} className="gap-1 h-8 px-2">
            ...
            {/* Share Button */}
            {onShare && (
              <Button variant="ghost" size="sm" onClick={onShare} className="gap-1 h-8 px-2">
                <Share2 className="w-4 h-4" />
                <span className="hidden lg:inline text-sm">แชร์</span>
              </Button>
            )}
            ...
            {/* Sign Out */}
            <Button variant="ghost" size="sm" onClick={onSignOut} className="gap-1 h-8 px-2">
