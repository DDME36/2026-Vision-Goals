...
import { Target, User, Lock, ArrowRight, Loader2, Eye, EyeOff } from 'lucide-react'
    ...
    >
      <div className="bg-card border border-border rounded-2xl shadow-xl p-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-4xl text-foreground mb-2">2026 Vision Board</h1>
          <p className="text-muted-foreground text-sm font-display">
            {mode === 'signin' ? 'ยินดีต้อนรับกลับ' : 'เริ่มต้นการเดินทาง'}
          </p>
        </div>
        ...
        <form onSubmit={handleUsernameAuth} className="space-y-4">
          ...
          <Button type="submit" className="w-full h-12" disabled={loading || loadingProvider !== null}>
            {loading ? (
              <Loader2 className="w-5 h-5 animate-spin" />
            ) : (
              <>
